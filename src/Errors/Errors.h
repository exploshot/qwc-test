 ...
 * however, it makes it easier to see at a glance what error you got, whilst developing
 */
enum ErrorCode
{
    /*!
     ...
     * QWC (or whatever is specified in WalletConfig::addressPrefix)
     */
    ...
    /*!
     * An error occurred whilst the daemon processed the request. Possibly our
     ...
     * with qwertycoin-wallet-backend-js
     */
