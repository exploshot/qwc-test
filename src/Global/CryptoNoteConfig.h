...
namespace CryptoNote {
	namespace parameters {
		 ...
		 * You can get this value by doing "print_block 2" in QDaemon. It is used to know what timestamp
		...
		/*!
		 * If you Fork QWC Please set the below value to 100000 NOT 10000
		 * as this will fix a mistake we made at Mainnet launch with transaction sizes
		 */
		 ...
		 *
		 * => Compile your code
		 * => Run SimpleWallet, ignore that it can't connect to the daemon, and generate an
		 *    address. Save this and the keys somewhere safe.
		 * => Launch the daemon with these arguments:
		 *    --print-genesis-tx --genesis-block-reward-address <premine wallet address>
		 *
		 *    For example:
		 *    QDaemon --print-genesis-tx --genesis-block-reward-address QWC1K6XEhCC1WsZzT9RRVpc1MLXXdHVKt2BUGSrsmkkXAvqh52sVnNc1pYmoF2TEXsAvZnyPaZu8MW3S8EWHNfAh7X2xa63P7Y
		 *
		 ...
		 * DustFund Parameters
		 *
		 * => CRYPTONOTE_DUST_OUT_LIMIT
		 *    the limit up to which dust outs should be removed and contributed back to the dust fund
		 */
		const uint64_t CRYPTONOTE_DUST_OUT_LIMIT 							= UINT64_C(1000000);
		 ...
		 * software will support the fork at 250720 blocks.
	...
	{
		{ BLOCK_MAJOR_VERSION_1, Crypto::CnSlowHashV0 },
		{ BLOCK_MAJOR_VERSION_2, Crypto::CnSlowHashV0 },
		{ BLOCK_MAJOR_VERSION_3, Crypto::CnSlowHashV0 },
		{ BLOCK_MAJOR_VERSION_4, Crypto::CnSlowHashV0 },
		{ BLOCK_MAJOR_VERSION_5, Crypto::CnSlowHashV0 },
		{ BLOCK_MAJOR_VERSION_6, Crypto::CnSlowHashV0 }
	};
