...
void help(bool viewWallet)
{
    std::cout
        ...
        << "[General]" << std::endl
        << SuccessMsg("address", 25) << "Display your payment address" << std::endl
        << SuccessMsg("balance", 25) << "Display how much " << WalletConfig::ticker << " you have" << std::endl
        ...
        << SuccessMsg("incoming_transfers", 25) << "Show incoming transfers" << std::endl
        ...
        << SuccessMsg("status", 25) << "Show daemon status" << std::endl;


    if (viewWallet) {
        std::cout << InformationMsg(
            "Please note you are using a view only "
            "wallet, and so cannot transfer " + WalletConfig::ticker + "."
        ) << std::endl;
    }
    else {
        std::cout
            << "[Spend wallet]" << std::endl
            << SuccessMsg("list_transfers", 25) << "Show all transfers" << std::endl
            << SuccessMsg("list_messages", 25) << "Show all messages" << std::endl
            << SuccessMsg("optimize", 25) << "Optimize your wallet to send large amounts" << std::endl
            << SuccessMsg("outgoing_transfers", 25) << "Show outgoing transfers" << std::endl
            << SuccessMsg("save_csv", 25) << "Save all wallet transactions to CSV file" << std::endl
            << SuccessMsg("transfer", 25) << "Send " << WalletConfig::ticker << " to someone" << std::endl;
    }
}
