    ...
    void handleSettings(int argc, char *argv[], DaemonConfiguration &config)
    {
        ...
        options.add_options ("Daemon")
                   ...
                   ("dump-config",
                    ...
                    cxxopts::value<bool> ()->default_value ("false")->implicit_value ("true"))
                   ("lmdb",
                    "Use lmdb for local cache files",
                    cxxopts::value<bool> (config.useLmdbForLocalCaches)->default_value ("false")
                                                                       ->implicit_value ("true"))
                   ("load-checkpoints",
        ...
        options.add_options ("Network")
                   ...
                   // Banning
                   ("p2p-ban-import",
                    "File to import p2p bans from.",
                    cxxopts::value<std::string> ()->default_value (config.banImportFile),
                    "<filepath>")
                   ("rpc-bind-ip",
