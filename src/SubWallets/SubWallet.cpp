...
Crypto::KeyImage SubWallet::getTxInputKeyImage(const Crypto::KeyDerivation derivation,
...
void SubWallet::markInputAsSpent(const Crypto::KeyImage keyImage,
    ...
    const std::unordered_set <Crypto::Hash> cancelledTransactions)
{
    ...
    /*!
     * Remove the inputs used in the cancelled transactions
     */
    if (it != m_lockedInputs.end ()) {
