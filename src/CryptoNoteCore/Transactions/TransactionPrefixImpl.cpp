...
namespace CryptoNote {
    ...
    public:
        ...
        TransactionPrefixImpl(const TransactionPrefix &prefix, 
        ...
        */
        ...
        virtual void getOutput(size_t index, 
                               KeyOutput &output, 
    ...
    {
        return std::accumulate(m_txPrefix.inputs.begin(), 
    ...
    {
        input = boost::get<KeyInput>(getInputChecked(m_txPrefix, 
                                                     index, 
    ...
    {
        return std::accumulate(m_txPrefix.outputs.begin(), 
    ...
    void TransactionPrefixImpl::getOutput(size_t index, 
                                          KeyOutput &output, 
    ...
    {
        return ::CryptoNote::findOutputsToAccount(m_txPrefix, 
                                                  addr, 
                                                  viewSecretKey, 
                                                  outs, 
                                                  outputAmount);
    ...
    {
        return std::unique_ptr<ITransactionReader> (new TransactionPrefixImpl(fullTransaction, 
                                                                              getObjectHash(fullTransaction)));
    }
} // namespace CryptoNote
