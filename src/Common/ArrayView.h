...
namespace Common {
    ...
    /*!
        \class ArrayView
        \inmodule Common
        \brief This is a pair of pointer to constant object of parametrized type and m_size.

        Supports 'EMPTY' and 'NIL' representations as follows:
        - 'm_data' == 'nullptr' && 'm_size' == 0 - EMPTY NIL
        - 'm_data' != 'nullptr' && 'm_size' == 0 - EMPTY NOTNIL
        - 'm_data' == 'nullptr' && 'm_size' > 0 - Undefined
        - 'm_data' != 'nullptr' && 'm_size' > 0 - NOTEMPTY NOTNIL
        For signed integer 'Size', 'ArrayView' with 'm_size' < 0 is undefined.
