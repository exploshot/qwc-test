 ...
 */
    ...
    Error hasMagicIdentifier(Buffer &data,
 ...
 */
WalletBackend::WalletBackend(const std::string filename,
 ...
 * or an error.
 */
std::tuple <Error, std::shared_ptr<WalletBackend>> WalletBackend::importWalletFromSeed(const std::string mnemonicSeed,
                                                                                       ...
                                                                                       const unsigned int syncThreadCount)
{
    ...
    const std::shared_ptr <WalletBackend> wallet (new WalletBackend (filename,
                                                                     password,
                                                                     privateSpendKey,
                                                                     privateViewKey,
                                                                     scanHeight,
...
WalletBackend::importWalletFromKeys(const Crypto::SecretKey privateSpendKey,
                                    const Crypto::SecretKey privateViewKey,
                                    const std::string filename,
                                    const std::string password,
                                    const uint64_t scanHeight,
 ...
 */
std::tuple <Error, std::shared_ptr<WalletBackend>>
WalletBackend::importViewWallet(const Crypto::SecretKey privateViewKey,
                                const std::string address,
                                const std::string filename,
                                const std::string password,
                                const uint64_t scanHeight,
...
bool WalletBackend::tryUpgradeWalletFormat(const std::string filename,
                                           const std::string password,
                                           const std::string daemonHost,
                                           const uint16_t daemonPort)
{
                                                                             ...
                                                                             const unsigned int syncThreadCount)
{
     ...
     */
    Error error = hasMagicIdentifier (buffer,
                                      Constants::IS_A_WALLET_IDENTIFIER,
                                      NOT_A_WALLET_FILE,
                                      NOT_A_WALLET_FILE);
    ...
    try {
         ...
         */
        error = wallet->fromJSON (walletJson,
                                  filename,
                                  password,
                                  daemonHost,
                                  daemonPort,
...
Error WalletBackend::saveWalletJSONToDisk(std::string walletJSON,
                                          std::string filename,
                                          std::string password)
{
    /*!
...
std::tuple <Error, Crypto::Hash> WalletBackend::sendFusionTransactionAdvanced(const uint64_t mixin,
                                                                              const std::vector <std::string> subWalletsToTakeFrom,
    ...
    return m_syncRAIIWrapper->pauseSynchronizerToRunFunction ([&, this]()
                                                              {
                                                                  ...
                                                                  if (!error) {
                                                                      ...
                                                                      uint64_t currentHeight =
                                                                          m_walletSynchronizer->getCurrentScanHeight ();
