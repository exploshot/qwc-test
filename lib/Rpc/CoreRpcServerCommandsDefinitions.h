...
namespace CryptoNote {
    ...
    struct COMMAND_RPC_GETBLOCKTEMPLATE
    {
        struct request
        {
            uint64_t reserve_size; //max 255 bytes - so why then uint64_t?
    ...
    struct COMMAND_RPC_GET_BLOCK_HEADERS_RANGE
    {
        ...
        {
            std::string status;
            std::vector<BlockHeaderResponse> headers;
            bool untrusted;
    ...
    struct FTransactionShortResponse
    {
        std::string hash;
        uint64_t fee;
        uint64_t amount_out;
    ...
    struct FTransactionDetailsResponse
    {
        std::string hash;
        uint64_t size;
    ...
    struct FBlockDetailsResponse
    {
        ...
        std::vector<FTransactionShortResponse> transactions;
    ...
    struct F_COMMAND_RPC_GET_BLOCKS_LIST
    {
        ...
        {
            /*!
             * transactions blobs as hex
             */
            std::vector<FBlockShortResponse> blocks;
            std::string status;
    ...
    struct F_COMMAND_RPC_GET_TRANSACTION_DETAILS
    {
        ...
        {
            Transaction tx;
            FTransactionDetailsResponse txDetails;
            FBlockShortResponse block;
            std::string status;
