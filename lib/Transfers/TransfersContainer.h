...
namespace CryptoNote {
    ...
    {
        /*!
         * attention Used only for TransactionTypes::OutputType::Key
         */
    ...
    private:
        ...
        typedef boost::multi_index_container<
            ...
            boost::multi_index::indexed_by<
                boost::multi_index::hashed_unique<BOOST_MULTI_INDEX_MEMBER(TransactionInformation,
                                                                           Crypto::Hash,
                                                                           transactionHash) >,
    ...
    private:
        ...
        /*!
         * current height is needed to check if a transfer is unlocked
         */
