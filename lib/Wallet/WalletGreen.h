...
namespace CryptoNote {
    ...
    public:
        ...
        virtual void initializeWithViewKey(const std::string &path,
        ...
        virtual void exportWallet(const std::string &path,
                                  bool encrypt = true,
        ...
        virtual std::string createAddress(const Crypto::SecretKey &spendSecretKey,
                                          const uint64_t scanHeight,
                                          const bool newAddress);
        virtual std::string createAddress(const Crypto::PublicKey &spendPublicKey,
                                          const uint64_t scanHeight,
                                          const bool newAddress);
        ...
        virtual size_t createFusionTransaction(uint64_t threshold,
                                               uint16_t mixin,
    ...
    protected:
        ...
        void incNextIv();
        void initWithKeys(const std::string &path,
                          const std::string &password,
...
#pragma pack(pop)
        ...
        virtual void
        onBlocksAdded(const Crypto::PublicKey &viewPublicKey,
        ...
        virtual void
        onTransactionDeleteBegin(const Crypto::PublicKey &viewPublicKey,
                                 Crypto::Hash transactionHash) override;
        void transactionDeleteBegin(Crypto::Hash transactionHash);

        virtual void
        onTransactionDeleteEnd(const Crypto::PublicKey &viewPublicKey,
                               Crypto::Hash transactionHash) override;
        ...
        uint64_t pushDonationTransferIfPossible(const DonationSettings &donation,
                                                uint64_t freeAmount,
        ...
        ReceiverAmounts splitAmount(uint64_t amount,
                                    ...
                                    uint64_t dustThreshold);
        ReceiverAmounts
        clearAndSplitAmount(uint64_t amount,
                            const AccountPublicAddress &destination,
                            uint64_t dustThreshold);
        ...
        bool updateAddressTransfers(size_t transactionId,
                                    size_t firstTransferIdx,
                                    const std::string &address,
                                    int64_t knownAmount,
                                    int64_t targetAmount);
        bool updateUnknownTransfers(size_t transactionId,
                                    size_t firstTransferIdx,
                                    ...
                                    int64_t totalAmount,
                                    bool isOutput);
        void appendTransfer(size_t transactionId,
                            size_t firstTransferIdx,
                            const std::string &address,
                            int64_t amount);
        bool adjustTransfer(size_t transactionId,
                            size_t firstTransferIdx,
                            const std::string &address,
                            int64_t amount);
        bool eraseTransfers(size_t transactionId,
                            size_t firstTransferIdx,
                            std::function<bool(bool, const std::string &)> &&predicate);
        bool eraseTransfersByAddress(size_t transactionId,
                                     size_t firstTransferIdx,
                                     const std::string &address,
                                     bool eraseOutputTransfers);
        bool eraseForeignTransfers(size_t transactionId,
                                   size_t firstTransferIdx,
        ...
        void insertUnlockTransactionJob(const Crypto::Hash &transactionHash,
        ...
        void copyContainerStorageKeys(ContainerStorage &src,
                                      const Crypto::chacha8Key &srcKey,
                                      ContainerStorage &dst,
                                      const Crypto::chacha8Key &dstKey);
        static void copyContainerStoragePrefix(ContainerStorage &src,
                                               const Crypto::chacha8Key &srcKey,
                                               ContainerStorage &dst,
                                               const Crypto::chacha8Key &dstKey);
        ...
        void loadWalletCache(std::unordered_set<Crypto::PublicKey> &addedKeys,
                             ...
                             std::string &extra);
        void saveWalletCache(ContainerStorage &storage,
                             const Crypto::chacha8Key &key,
        ...
        void filterOutTransactions(WalletTransactions &transactions,
        ...
        std::vector<std::tuple<WalletTypes::TransactionInput, Crypto::Hash>> getInputs(const WalletRecord subWallet,
                                                                                       const bool isViewWallet,
                                                                                       const bool unspent) const;

        Crypto::KeyImage getKeyImage(const Crypto::PublicKey transactionPublicKey,
