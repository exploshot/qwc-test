...
int geFromBytesVartime(geP3 *h, const unsigned char *s)
{
    ...
    int64_t h0 = load4 (s);
    int64_t h1 = load3 (s + 4)
        << 6;
    int64_t h2 = load3 (s + 7)
        << 5;
    int64_t h3 = load3 (s + 10)
        << 3;
    int64_t h4 = load3 (s + 13)
        << 2;
    int64_t h5 = load4 (s + 16);
    int64_t h6 = load3 (s + 20)
        << 7;
    int64_t h7 = load3 (s + 23)
        << 5;
    int64_t h8 = load3 (s + 26)
        << 4;
    int64_t h9 = (load3 (s + 29) & 8388607)
        << 2;
    int64_t carry0;
    int64_t carry1;
    int64_t carry2;
...
int scCheck(const unsigned char *s)
{
    ...
    return (int) (
        (
            ...
            (
                sigNum (1477600026 - s1)
                    << 1
            ) +
            (
                sigNum (2734136534 - s2)
                    << 2
            ) +
            (
                sigNum (350157278 - s3)
