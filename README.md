...
Hi Qwertycoin contributor, thanks for forking and sending back Pull Requests. Extensive docs about contributing are in the works or elsewhere. For now this is the bit we need to get into all the files we touch. Please add it to the top of the files, see [src/Global/CryptoNoteConfig.h](https://github.com/qwertycoin-org/qwertycoin/blob/master/src/Global/CryptoNoteConfig.h) for an example.
